...
module.exports = function (express, bodyParser, callback) {
    ...
    var CURRENT_ROUTE = '/dishes';
    var MODEL_NAME = 'dish';
    
    try {
        if (typeof express !== 'function' || typeof bodyParser !== 'function') {
            throw new Error("DISHES: You are setting up non application");
        } else {
            callback(null, {
                router: {},
                route: CURRENT_ROUTE,
                init: function () {
                    ...
                    router.route('/')
                            ...
                            .get(function (req, res, next) {
                                res.end('Will send all the ' + MODEL_NAME + 'es to you!');
                            })
                            ...
                            .delete(function (req, res, next) {
                                res.end('Deleting all ' + MODEL_NAME + 'es');
                            });
                    router.route('/:id')
                            .all(function (req, res, next) {
                                res.writeHead(200, {'Content-Type': 'text/plain'});
